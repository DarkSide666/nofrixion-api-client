...
/**
 * NoFrixionMoneyMoovModelsWebhookUpdate Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionMoneyMoovModelsWebhookUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.WebhookUpdate';
    ...
    */
     ...
     * Sets resource_types
     *
     * @param string[]|null $resource_types The resource types that the webhook should be generated for.
     *
     * @return self
     */
