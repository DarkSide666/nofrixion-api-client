...
class NoFrixionMoneyMoovModelsPayrunInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets pay_run_id
     *
     * @param string|null $pay_run_id The ID of the pay run this invoice belongs to.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Optional. The name of the invoice.
     *
     * @return self
     */
     ...
     * Sets payment_terms
     *
     * @param string|null $payment_terms Optional additional information about the invoice.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date Date the invoice was issued.
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date Date by which payment is due.
     *
     * @return self
     */
     ...
     * Sets contact
     *
     * @param string|null $contact Supplier's name
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string $currency Currency used in the invoice.
     *
     * @return self
     */
     ...
     * Sets discounts
     *
     * @param float|null $discounts Optional. Any discounts applied to the invoice.
     *
     * @return self
     */
     ...
     * Sets taxes
     *
     * @param float|null $taxes Optional. The total amount of taxes applied to the invoice.
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param float $total_amount Final total amount of the invoice, including discounts and taxes.
     *
     * @return self
     */
     ...
     *
     * @param float|null $outstanding_amount The amount that is still outstanding for this invoice.
     *
     * @return self
     */
     ...
     * Sets sub_total
     *
     * @param float|null $sub_total Optional. The total amount before discounts and taxes.
     *
     * @return self
     */
     ...
     *
     * @param string|null $remittance_email Email address to which a remittance note will be sent, if specified.
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_reference The reference sent to the recipient's bank. If left empty,  an autogenerated reference will be used instead.
     *
     * @return self
     */
