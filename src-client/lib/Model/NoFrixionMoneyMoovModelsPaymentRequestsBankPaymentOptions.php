<?php
/**
 * NoFrixionMoneyMoovModelsPaymentRequestsBankPaymentOptions
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionMoneyMoovModelsPaymentRequestsBankPaymentOptions Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionMoneyMoovModelsPaymentRequestsBankPaymentOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.PaymentRequests.BankPaymentOptions';
    ...
    */
    ...
    {
        return $this->container['destination_accounts'];
    }

    /**
     * Sets destination_accounts
     *
     * @param \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPaymentRequestsBankPaymentOptionsDestinationAccounts|null $destination_accounts destination_accounts
     *
     * @return self
     */
    public function setDestinationAccounts($destination_accounts)
    {
        if (is_null($destination_accounts)) {
            array_push($this->openAPINullablesSetToNull, 'destination_accounts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('destination_accounts', $nullablesSetToNull);
            if ($index !== FALSE) {
