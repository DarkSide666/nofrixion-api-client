...
/**
 * NoFrixionMoneyMoovModelsPaymentRequestsPaymentTerms Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionMoneyMoovModelsPaymentRequestsPaymentTerms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.PaymentRequests.PaymentTerms';
    ...
    {
        $this->setIfExists('allow_partial_payments', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $allow_partial_payments allow_partial_payments
     *
     * @return self
     */
    public function setAllowPartialPayments($allow_partial_payments)
    {
        if (is_null($allow_partial_payments)) {
            throw new \InvalidArgumentException('non-nullable allow_partial_payments cannot be null');
        }
