<?php
/**
 * NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestCustomFieldCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestCustomFieldCreate Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestCustomFieldCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.PaymentRequests.PaymentRequestCustomFieldCreate';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestCustomFieldCreate., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestCustomFieldCreate., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool|null $display_on_hosted_payment_page If true, the custom field will be displayed on the hosted payment page.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $display_on_payment_receipt If true, the custom field will be displayed on the payment receipt.
     *
     * @return self
     */
     ...
     * Sets display_order
     *
     * @param int|null $display_order The display order of the custom field. The lowest number is displayed first.  This is used to determine the order in which the custom fields are displayed  on the UI, for example, on the hosted payment page and payment receipt.
     *
     * @return self
     */
