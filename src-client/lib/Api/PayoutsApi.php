...
class PayoutsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFailedPayouts'] to see the possible values for this operation
     *
     * @throws \Nofrixion\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPayoutKeysetPageResponse
     */
    public function getFailedPayouts($merchant_id, $from_date_utc = null, $page_size = 20, string $contentType = self::contentTypes['getFailedPayouts'][0])
    {
        list($response) = $this->getFailedPayoutsWithHttpInfo($merchant_id, $from_date_utc, $page_size, $contentType);
        return $response;
    }

    /**
     * Operation getFailedPayoutsWithHttpInfo
     *
     * Get failed payouts for a specific merchant.
     *
     * @param  string $merchant_id The merchant id to get the failed payouts fro. (required)
     ...
     */
    public function getFailedPayoutsWithHttpInfo($merchant_id, $from_date_utc = null, $page_size = 20, string $contentType = self::contentTypes['getFailedPayouts'][0])
    {
        $request = $this->getFailedPayoutsRequest($merchant_id, $from_date_utc, $page_size, $contentType);
    ...
    /**
     * Operation getFailedPayoutsAsync
     *
     * Get failed payouts for a specific merchant.
     *
     * @param  string $merchant_id The merchant id to get the failed payouts fro. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFailedPayoutsAsync($merchant_id, $from_date_utc = null, $page_size = 20, string $contentType = self::contentTypes['getFailedPayouts'][0])
    {
        return $this->getFailedPayoutsAsyncWithHttpInfo($merchant_id, $from_date_utc, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFailedPayoutsAsyncWithHttpInfo
     *
     * Get failed payouts for a specific merchant.
     *
     * @param  string $merchant_id The merchant id to get the failed payouts fro. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFailedPayoutsAsyncWithHttpInfo($merchant_id, $from_date_utc = null, $page_size = 20, string $contentType = self::contentTypes['getFailedPayouts'][0])
    {
        $returnType = '\Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPayoutKeysetPageResponse';
        $request = $this->getFailedPayoutsRequest($merchant_id, $from_date_utc, $page_size, $contentType);
    ...
    /**
     * Create request for operation 'getFailedPayouts'
     *
     * @param  string $merchant_id The merchant id to get the failed payouts fro. (required)
     * @param  string $from_date_utc Optional. The date to fetch the payouts from. Must be ISO 8601 format (optional)
     * @param  int $page_size Optional. The page size. Default is 20 (optional, default to 20)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFailedPayoutsRequest($merchant_id, $from_date_utc = null, $page_size = 20, string $contentType = self::contentTypes['getFailedPayouts'][0])
    {

        // verify the required parameter 'merchant_id' is set
        if ($merchant_id === null || (is_array($merchant_id) && count($merchant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $merchant_id when calling getFailedPayouts'
            );
        }
        ...
        $resourcePath = '/api/v1/payouts/{merchantID}/failed';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
