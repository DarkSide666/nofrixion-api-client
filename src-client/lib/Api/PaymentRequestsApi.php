...
class PaymentRequestsApi
{
     ...
     * @param  string[] $payment_request_create_notification_role_ids An optional list of notification role IDs that will receive notifications  about the payment request. This is useful for roles that need to be notified  about payment request events. (optional)
    ...
    public function createAndPayPaymentRequestRequest($payment_request_create_amount, $card_sensitive_card_number, $card_sensitive_card_security_code, $card_sensitive_expiry_month, $card_sensitive_expiry_year, $card_expiry_month, $card_expiry_year, $payment_initiation_request_provider_id, $payment_request_create_merchant_id = null, $payment_request_create_currency = null, $payment_request_create_customer_id = null, $payment_request_create_order_id = null, $payment_request_create_payment_method_types = null, $payment_request_create_payment_methods = null, $payment_request_create_description = null, $payment_request_create_pisp_account_id = null, $payment_request_create_shipping_first_name = null, $payment_request_create_shipping_last_name = null, $payment_request_create_shipping_address_line1 = null, $payment_request_create_shipping_address_line2 = null, $payment_request_create_shipping_address_city = null, $payment_request_create_shipping_address_county = null, $payment_request_create_shipping_address_post_code = null, $payment_request_create_shipping_address_country_code = null, $payment_request_create_shipping_phone = null, $payment_request_create_shipping_email = null, $payment_request_create_origin_url = null, $payment_request_create_base_origin_url = null, $payment_request_create_callback_url = null, $payment_request_create_failure_callback_url = null, $payment_request_create_success_web_hook_url = null, $payment_request_create_card_authorize_only = null, $payment_request_create_card_create_token = null, $payment_request_create_card_create_token_mode = null, $payment_request_create_card_transmit_raw_details = null, $payment_request_create_card_processor_merchant_id = null, $payment_request_create_ignore_address_verification = null, $payment_request_create_card_ignore_cvn = null, $payment_request_create_pisp_recipient_reference = null, $payment_request_create_use_hosted_payment_page = null, $payment_request_create_card_no_payer_authentication = null, $payment_request_create_partial_payment_method = null, $payment_request_create_customer_email_address = null, $payment_request_create_payment_processor = null, $payment_request_create_lightning_invoice = null, $payment_request_create_lightning_invoice_expires_at = null, $payment_request_create_notification_email_addresses = null, $payment_request_create_priority_bank_id = null, $payment_request_create_title = null, $payment_request_create_partial_payment_steps = null, $payment_request_create_payrun_id = null, $payment_request_create_sandbox_settle_delay_in_seconds = null, $payment_request_create_tag_ids = null, $payment_request_create_tags = null, $payment_request_create_auto_send_receipt = null, $payment_request_create_custom_fields = null, $payment_request_create_due_date = null, $payment_request_create_field_display_settings = null, $payment_request_create_notification_role_ids = null, $card_sensitive_jwt_token = null, $card_sensitive_number_token = null, $card_sensitive_cvc_token = null, $card_sensitive_card_holder_first_name = null, $card_sensitive_card_holder_last_name = null, $card_sensitive_billing_address_line1 = null, $card_sensitive_billing_address_line2 = null, $card_sensitive_billing_address_city = null, $card_sensitive_billing_address_county = null, $card_sensitive_billing_address_post_code = null, $card_sensitive_billing_address_country_code = null, $card_sensitive_billing_phone = null, $card_sensitive_billing_email = null, $card_sensitive_save_card_consent = null, $card_sensitive_partial_amount = null, $card_jwt_token = null, $card_number_token = null, $card_cvc_token = null, $card_card_holder_first_name = null, $card_card_holder_last_name = null, $card_billing_address_line1 = null, $card_billing_address_line2 = null, $card_billing_address_city = null, $card_billing_address_county = null, $card_billing_address_post_code = null, $card_billing_address_country_code = null, $card_billing_phone = null, $card_billing_email = null, $card_save_card_consent = null, $card_partial_amount = null, $payment_method = null, $card_token_tokenised_card_id = null, $card_token_payment_initiator = null, $card_token_card_security_code = null, $card_token_partial_amount = null, $payment_initiation_request_partial_amount = null, $payment_initiation_request_redirect_to_origin_url = null, $payment_initiation_request_origin_url = null, string $contentType = self::contentTypes['createAndPayPaymentRequest'][0])
    {
        ...
        // form params
        if ($payment_request_create_field_display_settings !== null) {
            $formParams['PaymentRequestCreate.FieldDisplaySettings'] = ObjectSerializer::toFormValue($payment_request_create_field_display_settings);
        }
        // form params
        if ($payment_request_create_notification_role_ids !== null) {
            $formParams['PaymentRequestCreate.NotificationRoleIDs'] = ObjectSerializer::toFormValue($payment_request_create_notification_role_ids);
        }
        // form params
    ...
    /**
     * Operation createPaymentRequests
     *
     * Creates payment requests in batch.
     *
     * @param  \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPaymentRequestCreate[] $no_frixion_money_moov_models_payment_request_create A list of objects containing the details of the payment requests to create. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPaymentRequests'] to see the possible values for this operation
     *
     * @throws \Nofrixion\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse
     */
    public function createPaymentRequests($no_frixion_money_moov_models_payment_request_create = null, string $contentType = self::contentTypes['createPaymentRequests'][0])
    {
        list($response) = $this->createPaymentRequestsWithHttpInfo($no_frixion_money_moov_models_payment_request_create, $contentType);
        return $response;
    }

    /**
     * Operation createPaymentRequestsWithHttpInfo
     *
     * Creates payment requests in batch.
     *
     * @param  \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPaymentRequestCreate[] $no_frixion_money_moov_models_payment_request_create A list of objects containing the details of the payment requests to create. (optional)
     ...
     * @throws \Nofrixion\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPaymentRequestsWithHttpInfo($no_frixion_money_moov_models_payment_request_create = null, string $contentType = self::contentTypes['createPaymentRequests'][0])
    {
        $request = $this->createPaymentRequestsRequest($no_frixion_money_moov_models_payment_request_create, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation createPaymentRequestsAsync
     *
     * Creates payment requests in batch.
     *
     * @param  \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPaymentRequestCreate[] $no_frixion_money_moov_models_payment_request_create A list of objects containing the details of the payment requests to create. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPaymentRequestsAsync($no_frixion_money_moov_models_payment_request_create = null, string $contentType = self::contentTypes['createPaymentRequests'][0])
    {
        return $this->createPaymentRequestsAsyncWithHttpInfo($no_frixion_money_moov_models_payment_request_create, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPaymentRequestsAsyncWithHttpInfo
     *
     * Creates payment requests in batch.
     *
     * @param  \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPaymentRequestCreate[] $no_frixion_money_moov_models_payment_request_create A list of objects containing the details of the payment requests to create. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPaymentRequestsAsyncWithHttpInfo($no_frixion_money_moov_models_payment_request_create = null, string $contentType = self::contentTypes['createPaymentRequests'][0])
    {
        $returnType = '\Nofrixion\Client\Model\NoFrixionMoneyMoovApiFeaturesPaymentRequestsPaymentRequestsCreateResponse';
        $request = $this->createPaymentRequestsRequest($no_frixion_money_moov_models_payment_request_create, $contentType);
    ...
    /**
     * Create request for operation 'createPaymentRequests'
     *
     * @param  \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsPaymentRequestCreate[] $no_frixion_money_moov_models_payment_request_create A list of objects containing the details of the payment requests to create. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPaymentRequests'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createPaymentRequestsRequest($no_frixion_money_moov_models_payment_request_create = null, string $contentType = self::contentTypes['createPaymentRequests'][0])
    {



        $resourcePath = '/api/v1/paymentrequests/batchcreate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
