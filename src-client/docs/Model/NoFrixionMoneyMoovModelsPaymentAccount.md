...
**is_trust_account** | **bool** | Indicates if the payment account is a trust account. The account name is displayed in the statement  instead of the merchant name for trust accounts. | [optional]
...
**created_by_display_name** | **string** | Either the name of the user, merchant token or api key that created the account | [optional]
