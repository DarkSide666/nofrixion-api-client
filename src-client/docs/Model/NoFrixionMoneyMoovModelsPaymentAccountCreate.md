...
**physical_account_id** | **string** | For EUR accounts this can be set to the ID of another account that will act as the  backing physical account. The new account will then act as a Virtual account, able to   receive funds but the transactions will be recorded against the backing physical account. | [optional]
